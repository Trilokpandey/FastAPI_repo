...
def update_patient(patient_id :str, patient_update: PatientUpdate):
    ...
    if patient_id not in data:
        raise HTTPException(status_code=404, detail="patient doesn't exist in database.")
    ...
    # convert existing_patient_info ->pydantic obj ->for new bmi and verdict
    ...
    return JSONResponse(status_code=200,content='patient details updated successfully')
